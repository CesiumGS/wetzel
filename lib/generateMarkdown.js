        ...
        if (properties.hasOwnProperty(name)) {
            ...
            if (defined(items)) {
                if (defined(items.minimum) && defined(items.maximum)) {
                    md += '   * Each element in the array must be between ' + items.minimum + ' and ' + items.maximum + '.\n';
                } else if (defined(items.minimum)) {
                    md += '   * Each element in the array must be greater than or equal to ' + items.minimum + '.\n';
                } else if (defined(items.maximum)) {
                    md += '   * Each element in the array must be less than or equal to ' + items.maximum + '.\n';
                }
