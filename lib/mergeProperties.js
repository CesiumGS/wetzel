...
*
* @todo This function was originally a local function in `schema4Resolver.js`.
* There is a function with the same name, signature, documentation, call site
* and purpose in `schema3Resolver.js`, but the exact differences have not been
* analyzed. It may be possible to replace the function in `schema3Resolver.js`
* with this one.
*
